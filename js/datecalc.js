...
function convertToISO(xDate) {
    console.log('601-START. xDate = ' + xDate); //x = 'Fri Jun 23 2023 16:29:15 GMT+0100 (Central European Standard Time)';
...
/* 2023-04-08
 * today's date, and convert this into ISO format.
 *
*/
function setCurrentDate() {
    // today's date:
    dateToday = new (Date);
    DateTodayISO = convertToISO(dateToday);//console.log('618. DateTodayISO = ' + DateTodayISO); // correct. eg: 2023-04-08, 8th of April 2023
}
