 ...
 * Todo: make dynamical procedures. 
 * 
*/
function addCboSelect(idCell) {
	...
	option1.innerText = 'Shift  23.00 - 07.00';
	x.add(option1);
...
function fillInnerHTML(content, idRow, idColumn){
	if (idRow == 7 && idColumn == 7) {
	...
	} else if (idRow == 7 && idColumn == 55) {
		// ewi:  line above should be:    } else if (idRow == 7 && idColumn == 45) {
		...
		document.getElementById(idRow + '_' + idColumn).innerHTML = 'Patrick';
